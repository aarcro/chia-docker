...
## Basic Startup
```
docker run --name <container-name> -d ghcr.io/hddcoin-network/hddcoin:latest
...
#### Connect to testnet?
```
docker run -d --expose=58444 --expose=8555 -e testnet=true --name <container-name> ghcr.io/hddcoin-network/hddcoin:latest
```
